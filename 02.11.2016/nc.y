...
%type<list> core_block tlc_block numberd_block confirm_block labld_block
...
labld_block:
	LABL numberd_block {$$ = AddLabelToListBlock($2, $1);}
|	numberd_block
;

numberd_block:
	N NUM core_block {$$ = NumberBlocks($3, $2);}
|	core_block
;

core_block:
	/* empty */
|	iso_block {$$ = CreateListForString($1);}
|	expr_block {$$ = CreateListForString($1);}
|	tlc_block
;
